...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            <img src="https://source.unsplash.com/1000x300?{{ $posts[0]->category->name }}" class="card-img-top"
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="position-absolute px-3 py-2" style="background-color: rgba(0,0,0,0.7)"><a
                                href="/categories/{{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
